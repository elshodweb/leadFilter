    ...
    return {
      ...
      overview: {
        ...
        totalLeads: {
          ...
          badge: 'warm+hot',
          title: 'JAMI LIDLAR',
          subtitle: 'Lid sifatida aniqlangan mijozlar',
        },
        totalLids: {
          value: totalLeads,
          badge: 'warm+hot',
      ...
      aiImpact: {
        ...
        aiAvgResponseTime: {
          ...
          subtitle: 'AI bilan xabar yuborish vaqti',
        },
      },
      // 3. Konversiya
      conversion: {
        chatToLead: {
          value: `${chatToLeadRate}%`,
          rate: chatToLeadRate,
          title: 'CHAT-LID',
          subtitle: 'Chatdan lidga aylanish foizi',
        },
        leadToWon: {
          value: `${leadToWonRate}%`,
          rate: leadToWonRate,
          title: 'LID-IJOBIY YOPILGAN',
          subtitle: 'Liddan ijobiy yopilganiga aylanish foizi',
        },
        'chat-lead': {
          value: `${chatToLeadRate}%`,
          rate: chatToLeadRate,
